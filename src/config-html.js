...
import {TagDefinition,AttributeDefinition,UrlAttrDefinition,NumberAttrDefinition,AttrPair,ApprovedAttrDefinition} from './def';
import {HtmlTagFormatter,HtmlAttrFormatter,NumberAttrFormatter,UrlAttrFormatter,HtmlTagDef} from './html';
...
class ClassFormatter extends HtmlAttrFormatter
{
    ...
    sanitize( value )
    {
        ...
        {
            if ( (v = ClassFormatter.regex.exec(c)) !== null ) { r.push(c); }
        }
        return r.join(' ');
    }
}

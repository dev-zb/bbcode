...
let tag_defs = [
    ...
    new TagDefinition( 'center',    common_allowed, [], new HtmlTagFormatter('div', new AttribPair('class','center') ) ),
    ...
    new TagDefinition( 'spoiler',   common_allowed, [], new HtmlTagFormatter( 'span', new AttribPair('class', 'spoiler') ) ),

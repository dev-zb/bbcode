...
var StyleFormatter = function (_HtmlAttrFormatter) {
    ...
    function StyleFormatter() {
        ...
        return _possibleConstructorReturn(this, (StyleFormatter.__proto__ || Object.getPrototypeOf(StyleFormatter)).call(this, 'style'));
    }

    _createClass(StyleFormatter, [{
        key: 'sanitize',
...
var ClassFormatter = function (_HtmlAttrFormatter2) {
    ...
    function ClassFormatter() {
        ...
        return _possibleConstructorReturn(this, (ClassFormatter.__proto__ || Object.getPrototypeOf(ClassFormatter)).call(this, 'class'));
    }

    _createClass(ClassFormatter, [{
        key: 'sanitize',
        value: function sanitize(value) {
...
function _n(name) {
    var min = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Number.MIN_VALUE;
...
var bbcode_parser = exports.bbcode_parser = new _parser.Parser(new _tagParser.TagParser(elements, _format.bbcode_format));
var html_parser = exports.html_parser = new _parser.Parser(new _tagParser.TagParser(elements, _format.html_format));